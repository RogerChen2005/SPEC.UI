...
const selectedColor = ref(materialColors.find(color => color.name === mainStore.ColorPreference) || materialColors[0]);

watchEffect(() => {
    mainStore.setPreferences(theme.value,selectedColor.value.name);
});
</script>